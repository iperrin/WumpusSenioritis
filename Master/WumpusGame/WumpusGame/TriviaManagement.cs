...
namespace WumpusTest
{
  class TriviaManagement
    ...
    // CHANGE TRIVIA BACK TO THE VERSION ON GITHUB RIGHT NOW / OR IN THE ZIP FILE
    // MAKE UI CLASS W/ STUBS LIKE 'BUYARROWS()' OR SOMETHING
  {
    ...
    // resets all used questions/answers/secrets
    public void Reset()
    {
      this.nextQuestion = -1;
      this.nextSecret = 0;
    ...
    {
      // Scan this.wrongAnswers to see if any index that hasn't already been given as a secret == 1:
      ...
      return "No secrets are available at this time!";      
      
    }

    public String debugWrongAnswers()
    {
      String result = "";
      for (int i = 0; i < wrongAnswers.Length; i++)
      {
        result = result + wrongAnswers[i] + " ";
      }
      return result;
    }
