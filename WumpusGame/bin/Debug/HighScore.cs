...
using System.Threading.Tasks;
    ...
    class HighScore
    {
        ...
        {
            results = data;
            Record = System.IO.File.ReadAllLines(Environment.CurrentDirectory.Substring(0, (Environment.CurrentDirectory.Length - 10)) + @"\HighScoreRecord.txt");
            addScore();
            WriteNewScores();
        }
        ...
        {
            string[] scores = System.IO.File.ReadAllLines(Environment.CurrentDirectory.Substring(0,(Environment.CurrentDirectory.Length - 10)) + @"\HighScoreRecord.txt");
            return scores;
        }
        ...
        {
        System.IO.File.WriteAllLines(Environment.CurrentDirectory.Substring(0, (Environment.CurrentDirectory.Length - 10)) + @"\HighScoreRecord.txt", Record);
    }
    }
